...
<body>
	...
	<section id="contenedor">
		...
		<br />
		<form name="permiso_prof" method="post" action="r_permiso_prof.php">
		<table align="center" class="fondo" width="500px">
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" name="gra_pr" size="20px" maxlength="12" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
							<label>Suplente Propuesto</label>
						</td>
						<td colspan="2">
							<input type="text" name="supro_pr" size="20px" maxlength="35" class="inputexto" />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<select name="rem_pr" class="inputexto">
					...
					<tr>
						...
						<td colspan="2">
							<input type="date" name="fecper_pr" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<input type="text" name="motper_pr" size="20px" maxlength="140" class="inputexto" />
						</td>
					</tr>
					<tr>
