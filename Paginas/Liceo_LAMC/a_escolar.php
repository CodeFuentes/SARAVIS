...
<header id="Encabezado">
	...
	<section id="contenedor">
		<section id="area">
			<h2 align="center">Registrar el Año Escolar</h2>
			<br />
			<br />
			<br />
			...
			<table align="center" width="500px" class="fondo">
				...
				<tr>
					...
					<td align="left" width="250px">
						<input type="text" name="nombre_ae" value="" size="18" maxlength="9" required />
					</td>
				</tr>
				<tr>
					<td width="250px">
					...
					<td align="left" width="250px">
						<input type="date" name="fechai_ae" value="" size="18" required />
					</td>
				</tr>
				<tr>
					<td width="250px">
					...
					<td align="left" width="250px">
						<input type="date" name="fechac_ae" value="" size="18" required/>
					</td>
				</tr>
				<tr>
