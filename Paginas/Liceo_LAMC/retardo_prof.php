...
<body>
	...
	<section id="contenedor">
		<section id="area">
		<h2 align="center">Retardos</h2>
		<br />
		<form name="retardo_prof" method="post" action="r_retardo_prof.php">
		<table align="center" class="fondo" width="500px">
					...
					<tr>
						...
						<td colspan="2">
							<input type="time" name="hoen_pr" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<input type="time" name="holle_pr" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<input type="date" name="fecret_pr" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<input type="text" name="motret_pr" size="20px" maxlength="140" class="inputexto" />
						</td>
					</tr>
					<tr>
