...
<body>
	...
	<section id="contenedor">
		<section id="area">
			<h2 align="center">Consultar Representante</h2>
			<br />
			<br />
			<form name="consulta_re" action="buscar_re.php" method="post">
				<table align="center" width="500px" class="fondo">
					...
					<tr>
						...
						<select name="doc_bure" class="inputexto">
							<option>V</option>
							<option>E</option>
						</select>
						</td>
						<td align="left" width="250px">
							<input type="text" name="ci_r" value="" size="20" maxlength="8" class="inputexto" required />
						</td>
					</tr>
					<tr height="25px">
						<td>
