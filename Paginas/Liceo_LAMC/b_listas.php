...
<body>
	...
	<section id="contenedor">
		<section id="area">
			...
			<h2 align="center">Listas por Año y Sección.</h2>
			<br />
			<br />
				...
				<table align="center" width="500px" class="fondo">
					...
					<tr>
						<td align="center" width="250px">
							<input type="submit" value="" style="height:50px; width:50px; margin-left:60px; background:		url(lupa1.png) center no-repeat;" title="Buscar Lista" class="botones"/>
						</td>
						<td align="center" width="250px">
