...
<body>
	...
	<section id="contenedor">
		<section id="area">
			...
			<h2 align="center">Datos del Núcleo Familiar Paso 5/8</h2>

			<form name="n_familia" action="registro_nfamilia.php" method="post">
				<table align="center" width="500px" class="fondo">
					<tr>
						<td colspan="2">
							<label>Cantidad de Adultos Masculinos</label>
						</td>
						<td colspan="2">
							<input type="text" name="adultos_m" value="" size="12" maxlength="2"  class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>Cantidad de Adultos Femeninas</label>
						</td>
						<td colspan="2">
							<input type="text" name="adultos_f" value="" size="12" maxlength="2"  class="inputexto" required/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>Cantidad de Adolescentes Masculinos</label>
						</td>
						<td colspan="2">
							<input type="text" name="adoles_m" value="" size="12" maxlength="2" class="inputexto" required/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>Cantidad de Adolescentes Femeninas</label>
						</td>
						<td colspan="2">
							<input type="text" name="adoles_f" value="" size="12" maxlength="2" class="inputexto" required/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
						...
						<td colspan="2">
							<input type="text" name="nino_m" value="" size="12" maxlength="2" class="inputexto" required/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>Cantidad de Niñas</label>
						</td>
						<td colspan="2">
							<input type="text" name="nina_f" value="" size="12" maxlength="2" class="inputexto" required/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>Cantidad de Adultos Mayores Masculinos</label>
						</td>
						<td colspan="2">
							<input type="text" name="adultos_mm" value="" size="12" maxlength="2"  class="inputexto" required/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>Cantidad de Adultos Mayores Femeninas</label>
						</td>
						<td colspan="2">
							<input type="text" name="adultos_mf" value="" size="12" maxlength="2" class="inputexto" required/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>Total de Mienbros del Núcleo familiar</label>
						</td>
						<td colspan="2">
							<input type="text" name="t_familia" value="" size="12" maxlength="2" class="inputexto" required/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
						...
						<td colspan="2">
							<select name="tipo_casa" class="inputexto">
					...
					<tr>
						...
						<td colspan="2">
							<select name="te_casa" class="inputexto">
								<option>Propia</option>
								<option>Alquilada</option>
								<option>Cedida</option>
								<option>Invadida</option>
								<option>otro</option>
							</select>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>¿Está Inscrito en la Gran Misión Vivienda Venezuela?</label>
						</td>
						<td colspan="2">
							<select name="mision_v" class="inputexto">
								<option>Si</option>
								<option>No</option>
							</select>
						</td>
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" name="cod_mv" size="12" value="" maxlength="8" class="inputexto" />
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>¿Recibe algún Beneficio por alguna otra Misión?</label>
						</td>
						<td colspan="2">
							<select name="mision_bo" class="inputexto">
								<option>Si</option>
								<option>No</option>
							</select>
						</td>
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" name="beneficio" size="18" value="" maxlength="20"  class="inputexto" />
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<label>Ingreso Mesual</label>
						</td>
						<td colspan="2">
							<input type="text" name="ingre_fa" size="12" value="" maxlength="8" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td>
								<a href="n_ingreso_e.php">
							...
							<td align="left">
								<input type="reset" name="cancelar" value="" style="height:50px; width:50px; margin-right:20px; margin-left:-40px; background:		url(cancelar1.png) center no-repeat;" title="Cancelar" class="botones" />
							</td>
							</td>
							<td align="right">
