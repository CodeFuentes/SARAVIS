...
<body>
	...
	<section id="contenedor">
		<section id="area">
		<h2 align="center">Registro Datos del Docente. Paso 1</h2>
		<br />
			<form name="registro_prof" action="registro_pro.php" method="post">
				<table align="center" width="500px" class="fondo">
					<tr>
						...
						<td>
							<input type="text" name="ci_pr" size="16" maxlength="8" class="inputexto" required value="" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="2">
							<input type="text" name="ape_pr" size="20" maxlength="35" class="inputexto" required value="" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="2">
							<input type="text" name="nom_pr" size="20" maxlength="35" value="" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="2">
							<input type="date" name="fec_pr" class="inputexto" value="" required />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="2">
							<input type="text" name="lug_pr" size="20" maxlength="60" value="" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" name="cua_pr" size="12" maxlength="1" value="" class="inputexto" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="2">
							<input type="text" name="dire_pr" size="30" maxlength="160" value="" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="2">
							<input type="text" name="teca_pr" size="18" maxlength="11" value="" class="inputexto" />
						</td>
					</tr>
					<tr> 
						<td>
						...
						<td colspan="2">
							<input type="text" name="tece_pr" size="18" maxlength="11" value="" class="inputexto" />
						</td>
					</tr>			
					<tr>
						<td>
						...
						<td>
							<input type="text" name="coel_pr" size="20" maxlength="60" value="" class="inputexto" />
						</td>
					</tr>
					<tr>
						<td align="center" width="245px">
							<input type="submit" value="" style="height:50px; width:50px; margin-left:60px; background:		url(guardar1.png) center no-repeat;" title="Buscar" class="botones"/>
						</td>
						<td width="10px">
						</td>
						<td align="center" width="245px">
