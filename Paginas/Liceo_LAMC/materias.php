...
<body>
	...
	<section id="contenedor">
		<section id="area">
			<h2 align="center">Registrar Materias</h2>
			<br />
			<br />
			<br />
			<form name="meterias" method="post" action="registro_materia.php">
				<table align="center" width="500px" class="fondo">
					<tr>
						<td>
							<label>Código de Maeteria</label>
						</td>
						<td>
							<input type="text" name="cod_mate" value="" size="20" maxlength="8" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" name="nom_mate" value="" size="20" maxlength="18" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td>
							<label>Año en el que se Imparte</label>
						</td>
						<td>
							<input type="text" name="anio_mate" value="" size="12" maxlength="2" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td align="right">
							<input type="submit" name="guardar" value="" style="height:50px; width:50px; margin-right:40px; background:		url(guardar1.png) center no-repeat;" title="Guardar" class="botones" />
						</td>
						<td align="center">
						<input type="reset" name="cancelar" value="" style="height:50px; width:50px; margin-right:80px; background:url(cancelar1.png) center no-repeat;" title="Cancelar" class="botones" />
						</td>
					</tr>
 				</table>
			</form>
