...
<header id="Encabezado">
	...
	<section id="contenedor">
		...
		<section id="area">
				...
				<h2 align="center">Datos de La Madre. Paso 1/8</h2>
				<br />
				<form name="incripcion_n" method="post" action="registro_in.php">
					<table align="center" width="500px" class="fondo">
						<tr>
							...
							<td align="right">
								<select name="doc_m" class="inputexto">
									<option>V</option>
									<option>E</option>
								</select>
							</td>
							<td align="left">
								<input type="text" name="ci_m" value="" size="18" maxlength="8" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" name="nombre_m" value="" size="30" maxlength="35" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" name="apellido_m" value="" size="30" maxlength="35" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="date" name="fechan_m" value="" size="30" required class="inputexto" />
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<select name="grado_in_m" class="inputexto">
						...
						<tr>
							...
							<td colspan="2">
								<input type="text" name="ocupacion_m" size="30" value="" maxlength="35" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" name="ltrabajo_m" size="30" value="" maxlength="40" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" name="telf_m" size="6" value="" maxlength="4" required class="inputexto"/>
							</td>
							<td>
								<input type="text" name="telf_m" size="16" value="" maxlength="7" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" value="" name="origen_m" size="30" maxlength="25" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<select name="ec_m" class="inputexto">
						...
						<tr>
							...
							<td colspan="2">
								<textarea name="direccion_m" rows="3" cols="30" required class="inputexto">
								</textarea>
							</td>
						</tr>
						<tr>
							...
							<td colspan="2">
								<select name="grupo_fm" class="inputexto">
									<option>Si</option>
									<option>No</option>
								</select>
							</td>
						...
						<td>
								<a href="n_ingreso_p.php">
									<input type="button" name="siguiente" value="" style="height:50px; width:50px; margin-right:40px; background:url(siguiente.png) center no-repeat;" title="Pág. Sigiente" class="botones" />
								</a>
							</td>
						</tr>
					</table>
