...
<header id="Encabezado">
	...
	<section id="contenedor">
		...
		<section id="area">
				...
				<h2 align="center">Datos del Representante. Paso 3/8</h2>
				<br />
				<form name="incripcion_n" method="post" action="registro_in_r.php">
					<table align="center" width="500px" class="fondo">
						...
						<tr>
							...
							<td>
								<input type="text" name="ci_r" value="" size="20" maxlength="8" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" name="nombre_r" value="" size="30" maxlength="35" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" name="apellido_r" value="" size="30" maxlength="35" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="date" name="fechan_r" value="" size="30" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td colspan="2">
								<input type="text" name="ocupacion_r" size="30" value="" maxlength="35" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" name="ltrabajo_r" size="30" value="" maxlength="40" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" name="telf_r" size="6" value="" maxlength="4" required class="inputexto"/>
							</td>
							<td>
								<input type="text" name="telf_r" size="16" value="" maxlength="7" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td colspan="2">
								<input type="text" value="" name="origen_r" size="30" maxlength="25" required class="inputexto"/>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td colspan="2">
								<textarea name="direccion_r" rows="3" cols="30" required class="inputexto">
								</textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="center">
								<input type="submit" name="guardar" value="" style="height:50px; width:50px; margin-right:20px; background:		url(guardar1.png) center no-repeat;" title="Guardar datos del Representante" class="botones" />
							</td>
							<td align="center">
