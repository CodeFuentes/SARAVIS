...
<body>
	...
	<nav id="barra">
		<table width="1231" height="32px" align="center">
			<tr valign="top">
	...
	<nav id="nav">
		<ul class="mainmenu">
		<table align="center" class="barra_nav" width="1230">
			<tr valign="top">
			<td width="243">
			<li>
				<a href="#">Registros</a>
	...
	<section id="contenedor">
		<section id="area">
		<h2 align="center">Aviso de Reposo</h2>
		<br />
		<form name="reposo_prof" method="post" action="r_reposo_prof.php">
		<table align="center" class="fondo" width="500px">
					...
					<tr>
						<td width="200px">
							<label>Organismo de Expedicion</label>
						</td>
						<td colspan="2">
							<input type="text" name="orex_pr" size="20px" maxlength="100" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<input type="date" name="fecin_pr" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<input type="date" name="feccul_pr" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<input type="date" name="rein_pr" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<input type="text" name="des_pr" size="20px" maxlength="140" class="inputexto" required />
						</td>
					</tr>
					<tr>
