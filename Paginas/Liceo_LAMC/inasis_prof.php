...
<body>
	...
	<section id="contenedor">
		<section id="area">
		<h2 align="center">Inasistencia</h2>
		<br />
		<form name="reposo_prof" method="post" action="r_inasis_prof.php">
		<table align="center" class="fondo" width="500px">
					...
					<tr>
						...
						<td colspan="2">
							<input type="date" name="fecinas_pr" class="inputexto" required />
						</td>
					</tr>
					<tr>
						<td width="200px">
						...
						<td colspan="2">
							<select name="jus_pr" class="inputexto">
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" name="motina_pr" size="20px" maxlength="140" class="inputexto" required />
						</td>
					</tr>
					<tr>
