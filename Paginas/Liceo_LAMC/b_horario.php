...
<body>
	...
	<section id="contenedor">
		<section id="area">
			...
			<h2 align="center">Consultar Horarios de Clase.</h2>
			<br />
			<br />
				...
				<table align="center" width="500px" class="fondo">
					...
					<tr>
						<td align="center" width="250px">
							<input type="submit" value="" style="height:50px; width:50px; margin-left:60px; background:		url(lupa1.png) center no-repeat;" title="Generar Horario" class="botones"/>
						</td>
						<td align="center" width="250px">
