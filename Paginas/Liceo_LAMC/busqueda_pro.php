...
<body>
	...
	<section id="contenedor">
		<section id="area">
			<h2 align="center">Consultar Profesor</h2>
			<br />
			<br />
				...
				<table align="center" width="500px" class="fondo">
					...
					<tr>
						<td align="center" width="">
							<input type="submit" value="" class="botones" style="height:50px; width:50px; margin-left:60px; background:		url(lupa1.png) center no-repeat;" title="Buscar"/>
						</td>
						<td align="center" width="">
							<input type="reset" value="" class="botones" style="height:50px; width:50px; margin-leftt:60px; margin-right:-80px; background:		url(cancelar1.png) center no-repeat;" title="Cancelar" />
						</td>
						<td align="center" width="">
						<a href="registro_prof.php">
						<input type="button" value="" class="botones" style="height:60px; width:60px; margin-right:15px; background:		url(agregar.png) center no-repeat;" title="Agregar Docente"/>
						</a>
						</td>
					</tr>
					</tr>
