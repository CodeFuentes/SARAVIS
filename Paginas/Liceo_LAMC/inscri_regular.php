...
$sql="select * from d_estudiante where ci_es='".$_REQUEST['ci_es']."'";
...
<body>
	...
	<section id="contenedor">
		<section id="area">
				<h2 align="center">Inscripción Regular</h2>
				<h2 align="center">Datos del Estudiante.</h2>
				<br />
			<form name="datos_estudiante" action="r_reg_ingreso.php" method="post">
				<table align="center" class="fondo" width="500px">
					<tr>
						...
						<td colspan="2" align="left">
							<input type="text" name="ci_es" size="15" maxlength="8" value="<?php echo $bus['ci_es']?>" class="inputexto" />
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" name="ape_es" size="20" maxlength="30" value="<?php echo $bus['ape_es']?>" required class="inputexto"/>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<input type="text" name="nom_es" size="20" maxlength="30" value="<?php echo $bus['nom_es']?>" required class="inputexto"/>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<select name="sex_es" class="inputexto">
								<option selected><?php echo $bus['sex_es']?></option>
					...
					<tr>
						...
						<td>
							<input type="date" name="fechanac_es" value="<?php echo $bus['fechanac_es']?>" required class="inputexto" />
						</td>
						<td>
							<label>Edad</label>
						</td>
						<td align="left">
							<input type="text" name="edad_es" value="<?php echo $bus['edad_es']?>" size="5" maxlength="2" required class="inputexto" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<input type="text" name="lugarnac_es" value="<?php echo $bus['lugarnac_es']?>" size="20"  maxlength="35" required class="inputexto"/>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<select name="vive_es" class="inputexto">
								<option selected><?php echo $bus['vive_es']?></option>
								<option>Madre</option>
								<option>Padre</option>
								<option>Ambos</option>
						...
						<td>
							<input type="text" name="vive_e_es" value="<?php echo $bus['vive_e_es']?>" size="20" maxlength="60" required class="inputexto" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<input type="text" name="direc_es"  width="60px" height="10px" value="<?php echo $bus['direc_es']?>" class="inputexto" >
					...
					<tr>
						...
						<td colspan="3">
							<input type="date" name="fechain_es" value="<?php echo $bus['fechain_es']?>" required class="inputexto" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="3">
							<input type="text" name="obser_es" value="<?php echo $bus['obser_es']?>" size="20" maxlength="60" required class="inputexto" />
						</td>
					</tr>

						<tr>
							<td align="center">
								<input type="submit" name="Modificar" value="" style="height:50px; width:50px; margin-left:20px; background:		url(guardar1.png) center no-repeat;" title="Guardar Datos" class="botones" />
							</td>
							<td>
							</td>
							<td>
