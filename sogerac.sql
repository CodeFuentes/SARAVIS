...
--
-- Servidor: localhost
-- Tiempo de generación: 21-01-2016 a las 20:04:00
...
--
-- Volcar la base de datos para la tabla `certificados`
--
...
--
-- Volcar la base de datos para la tabla `ediciones`
--
...
--
-- Volcar la base de datos para la tabla `ediciones_personas`
--
...
--
-- Volcar la base de datos para la tabla `identificadores`
--
...
INSERT INTO `personas` (`id_persona`, `documento`, `nombre`, `apellido`, `sexo`, `fecha_nacimiento`, `telefono`, `direccion`) VALUES
